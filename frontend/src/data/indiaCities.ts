const INDIA_CITIES: Record<string, string[]> = {
  'Andhra Pradesh': [
    ...
    'Konaseema','Krishna','Kurnool','Manyam (Parvathipuram)','Nandyal',
    'NTR','Nellore','Palnadu','Prakasam','Srikakulam',
    'Sri Sathya Sai','Tirupati','Vizianagaram','Visakhapatnam','West Godavari',
    'YSR Kadapa','Guntur (Urban)','Visakhapatnam (Urban)',
  ],
  'Karnataka': [
